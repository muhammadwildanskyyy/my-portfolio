...
image: "/images/projects/noise-filter/noise-filter.png"
tag: "C++ and OpenCV"
images:
...
<CodeBlock compact marginBottom="16" codes={[
  {
    code: "git clone https://github.com/muhammadwildanskyyy/adaptive-Median-Filter_wiener-Filter_anisotropic-Diffusion.git",
    language: "bash"
  }
]} />
